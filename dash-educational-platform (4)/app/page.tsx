  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-gray-500 md:text-xl">
                    Upload your class notes and let our AI generate personalized flashcards, trivia questions, and
                    NoteDown challenges to accelerate your learning.
                  </p>
                </div>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-50">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">NoteDown</h2>
                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
              ...
              <div className="mx-auto max-w-3xl text-center">
                <p className="mb-8 text-gray-500">
                  NoteDown is a fast-paced, interactive trivia game inspired by the structure and excitement of Quiz
                ...
                <div className="mt-8">
                  <Link href="/notedown">
                    <Button size="lg">Try NoteDown</Button>
                  </Link>
                </div>
              </div>
            </div>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full border-t px-4 md:px-6">
        <p className="text-xs text-gray-500">© 2025 Noteify. All rights reserved.</p>
