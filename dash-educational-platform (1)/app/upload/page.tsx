    ...
    try {
      ...
      if (file) {
        if (file.type === "text/plain" || file.name.endsWith(".md") || file.name.endsWith(".txt")) {
          ...
          // For now, we'll show an alert that PDF processing isn't implemented yet
          alert("PDF processing will be implemented soon. Please use text or markdown files for now.")
      ...
      const generatedQuestions = await generateQuestionsAction(textContent)
