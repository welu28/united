        ...
        <div className="mx-auto max-w-4xl">
          <div className="grid gap-8">
            <div className="text-center space-y-4">
              <h1 className="text-4xl font-bold tracking-tight">About -Dash</h1>
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-gray-500 max-w-2xl mx-auto">
                Join thousands of students who are already using -Dash to improve their academic performance and Quiz
                Bowl skills.
              </p>
