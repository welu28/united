...
interface ActivityItem {
  ...
  time: string
  score?: number
  type: "flashcard" | "trivia" | "qb-reader" | "create" | "upload" | "profile"
}
...
export default function ProfilePage() {
  ...
  const loadUserStats = () => {
    ...
    // Get QB Reader ELO from localStorage
    ...
    setStats({
      ...
      qbReaderScore: currentElo, // Use the directly stored ELO
      gamesPlayed,
      questionsAnswered,
      correctAnswers,
    })
  ...
  const loadRecentActivity = () => {
    ...
    setRecentActivity(
      sortedActivity.length > 0
        ...
        : [
            {
              activity: "Welcome to -Dash! Start creating study sets to see your activity here.",
              time: "now",
              ...
              <TabsContent value="overview" className="mt-6">
                <div className="grid gap-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <Card>
                      <CardHeader>
                        <CardTitle>QB Reader Score</CardTitle>
                        <CardDescription>Your competitive ranking</CardDescription>
                      </CardHeader>
                      <CardContent>
                        <div className="text-3xl font-bold text-blue-600">{stats.qbReaderScore}</div>
                        <p className="text-sm text-gray-500 mt-2">
                          {stats.qbReaderScore >= 1200
                            ? "Expert level!"
                            : stats.qbReaderScore >= 1000
                              ? "Intermediate level"
                              : "Beginner level"}
                        </p>
                      </CardContent>
